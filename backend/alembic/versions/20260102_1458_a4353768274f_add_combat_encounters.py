...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_combat_encounters_session_id", "combat_encounters", ["session_id"], unique=False
    )
    op.create_index(
        "ix_combat_encounters_is_active", "combat_encounters", ["is_active"], unique=False
    )
    op.create_index(
        "ix_combat_session_active", "combat_encounters", ["session_id", "is_active"], unique=False
    )
