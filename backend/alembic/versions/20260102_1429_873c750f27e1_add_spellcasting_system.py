...
def upgrade() -> None:
    ...
    op.create_index('ix_character_spells_character_id', 'character_spells', ['character_id'], unique=False)
    ...
    op.create_index('ix_character_spells_prepared', 'character_spells', ['character_id', 'is_prepared'], unique=False)
