...
from app.models.character import Character, InventoryItem, CharacterSpell
from app.models.game import GameSession, Combat, NPC, Quest, QuestObjective
...
class TestCombatModel:
    ...
    @pytest.mark.asyncio
    async def test_combat_round_progression(
        self,
        db_session: AsyncSession,
        sample_combat: Combat
    ):
