...
SPELL_SEED_DATA = [
    ...
    # Level 1 Spells
    {
        ...
        "somatic": True,
        "material": None,
        "description": "You create three glowing darts of magical force. Each dart hits a creature of your choice that you can see within range. A dart deals 1d4 + 1 force damage to its target. When cast using a spell slot of 2nd level or higher, the spell creates one more dart for each slot level above 1st.",
        "is_concentration": False,
        "is_ritual": False,
        "damage_dice": "1d4+1",
        "damage_type": "force",
    ...
    },
    {
        ...
        "somatic": True,
        "material": None,
        "description": "A creature you touch regains a number of hit points equal to 1d8 + your spellcasting ability modifier. This spell has no effect on undead or constructs. At higher levels: +1d8 per slot level above 1st.",
        "is_concentration": False,
        "is_ritual": False,
        "damage_dice": "1d8",
        "damage_type": "healing",
    ...
    # Level 2 Spells
    {
        ...
        "somatic": True,
        "material": None,
        "description": "You create three rays of fire and hurl them at targets within range. Make a ranged spell attack for each ray. On a hit, the target takes 2d6 fire damage. At higher levels: Create one additional ray for each slot level above 2nd.",
        "is_concentration": False,
        "is_ritual": False,
        "damage_dice": "2d6",
        "damage_type": "fire",
    ...
    # Level 3 Spells
    {
        ...
        "description": "A bright streak flashes from your pointing finger to a point you choose within range and then blossoms with a low roar into an explosion of flame. Each creature in a 20-foot-radius sphere centered on that point must make a Dexterity saving throw. A target takes 8d6 fire damage on a failed save, or half as much damage on a successful one. At higher levels: +1d6 per slot level above 3rd.",
        "is_concentration": False,
        "is_ritual": False,
        "damage_dice": "8d6",
        "damage_type": "fire",
