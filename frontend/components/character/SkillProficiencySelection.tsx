...
export default function SkillProficiencySelection({
	...
	// Normalize class name to match CLASS_SKILL_PROFICIENCIES keys (capitalize first letter)
	const normalizedClassName = characterClass.charAt(0).toUpperCase() + characterClass.slice(1);
	const classRules = CLASS_SKILL_PROFICIENCIES[normalizedClassName];
		...
		return (
			<Card className="p-6">
				<p className="text-red-500">
					Error: Skill proficiencies not found for class "{characterClass}".
